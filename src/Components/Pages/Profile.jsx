...
import { FaCamera, FaRegClock, FaRegComment } from "react-icons/fa";
import { PiCity, PiShareFatLight } from "react-icons/pi";
import { useParams } from "react-router-dom";
import { getComments } from "../utils/fake_api/comments";
import { getLike } from "../utils/fake_api/like";
import { getPost } from "../utils/fake_api/posts";
import { getUserById } from "../utils/fake_api/users";
...
export default function Profile() {
  ...
  const handleOpenModal = () => {
    ...
    // Hình
    setFormData(userLS);
    setProfilePreview(userLS.profilepic || "");
    setCoverPreview(userLS.coverpic || "");
    setIsModalOpen(true);
  };
  // Hinh
